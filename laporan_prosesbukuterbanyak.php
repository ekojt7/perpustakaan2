  ...
  <body>
	...
	<ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3>Buku Terbanyak Dipinjam Periode <?php echo $tgl_mulai; ?> - <?php echo $tgl_selesai; ?></h3>
...
<tbody>
    ...
    <?php
        ...
        $query = "SELECT no_inv,judul,COUNT(no_inv) AS jml FROM history 
        WHERE tgl_pinjam BETWEEN '$tgl_mulai' AND '$tgl_selesai' GROUP BY no_inv ORDER BY jml DESC;";
