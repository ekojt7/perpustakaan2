  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
            <form class="form-horizontal" action="user_prosesinput.php" method="post">
  <div class="form-group">
    <label for="nis" class="col-sm-2 control-label">User</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="user" placeholder="User" name="user">
    </div>
  </div>
  <div class="form-group">
    <label for="paswd" class="col-sm-2 control-label">Password</label>
    <div class="col-sm-6">
      <input type="password" class="form-control" id="paswd" placeholder="Password" name="paswd">
    </div>
  </div>
  <div class="form-group">
