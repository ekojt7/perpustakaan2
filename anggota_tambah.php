  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
            <form class="form-horizontal" action="anggota_prosesinput.php" method="post">
...
<div class="radio">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
        <textarea class="form-control" rows="3" id="alamat" placeholder="Alamat" name="alamat"></textarea>
    </div>
  </div>
  <div class="form-group">
