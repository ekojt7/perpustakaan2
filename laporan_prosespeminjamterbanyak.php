  ...
  <body>
	...
	<ul class="nav navbar-nav navbar-right navbar-user">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3>Laporan Peminjam Terbanyak Periode <?php echo $tgl_mulai; ?> - <?php echo $tgl_selesai; ?></h3>
...
<tbody>
    ...
    <?php
        ...
        $query = "SELECT nis,nama,COUNT(nis) AS jml FROM history 
        WHERE tgl_pinjam BETWEEN '$tgl_mulai' AND '$tgl_selesai' GROUP BY nis ORDER BY jml DESC";
