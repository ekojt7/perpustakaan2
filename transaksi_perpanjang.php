  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
       ...
       $thn_kbl=substr($d['tgl_kembali'],0,4);
       $bln_kbl=substr($d['tgl_kembali'],5,2);
       $hr_kbl=substr($d['tgl_kembali'],8,2);
       $n =7;
       $perpanjang = mktime(0,0,0,$bln_kbl,$hr_kbl + $n,$thn_kbl);
       $hsperpanjang = date("Y-m-d", $perpanjang);
       
       $edit = mysql_query("update sirkulasi set tgl_kembali='$hsperpanjang' where id_transaksi='$id'");
        ?>

        <div class="row">
          <div class="col-lg-12">
            
            <h3>Buku Berhasil Diperpanjang</h3>
