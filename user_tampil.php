    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
       ...
       <?php
            ...
            if (isset($_GET['berhasiledit'])) {
			echo "<div id='form_alert' style='color:#DD1144' class='alert alert-success'>";
			echo "<a class='close' data-dismiss='alert' href='#'>x</a>Data berhasil diedit !";
			echo "</div>";
		}
        
        else if (isset($_GET['salahpassword'])) {
			echo "<div id='form_alert' style='color:#DD1144' class='alert alert-success'>";
			echo "<a class='close' data-dismiss='alert' href='#'>x</a>Password Lama Yang Anda Masukan Tidak Sesuai !";
			echo "</div>";
		}
		?>
 <div class="row">
...
<tbody>
    ...
    <?php
        ...
        $query = "SELECT id_user,user,nama FROM user";
	...
	<tr>
		...
		<td align="center"><a class="btn btn-warning fa fa-edit" href="<?php echo "user_edit.php?id_user=$data[id_user]"; ?>"></a></td>
        <td align="center"><a class="btn btn-danger fa fa-trash-o" href="<?php echo "user_hapus.php?id_user=$data[id_user]"; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">
            </a></td>
        <?php
