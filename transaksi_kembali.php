  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <?php
            ...
            if (isset($_GET['berhasildikembalikan'])) {
			echo "<div id='form_alert' style='color:#DD1144' class='alert alert-success'>";
			echo "<a class='close' data-dismiss='alert' href='#'>x</a>Buku berhasil dikembalikan !";
			echo "</div>";
		}
        ...
        <div class="row">
            <form class="form-inline" action="transaksi_proseskembali.php" method="post">
