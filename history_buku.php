  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
            <form class="form-inline" action="history_prosesbuku.php" method="post">
  <div class="form-group">
    <label class="sr-only" for="no_inv">No.Inv</label>
    <input type="text" class="form-control" id="no_inv" placeholder="Masukan No.Inv ..." name="no_inv">
  </div>
